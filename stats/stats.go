...
type Stats struct {
    MemStats  *linux.MemInfo // Memory statistics
    DiskStats *linux.Disk    // Disk statistics
    CpuStats  *linux.CPUStat // CPU statistics
    LoadStats *linux.LoadAvg // Load average statistics
