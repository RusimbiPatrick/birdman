...
type Task struct {
    ...
    HostPorts     map[string]string // Example: {"8080/tcp": "127.0.0.1:8080"}
    RestartCount  int                // Number of times the task has been restarted
    HealthCheck   string             // Health check endpoint (e.g., "/health")
}
